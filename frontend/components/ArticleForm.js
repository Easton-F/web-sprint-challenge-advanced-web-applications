...
export default function ArticleForm(props) {
  ...
  const onSubmit = evt => {
    ...
    currentArticle ? updateArticle({article: values, article_id: currentArticle.article_id}) : postArticle(values)
    setValues(initialFormValues);
  }
  ...
  return (
    ...
    <form id="form" onSubmit={onSubmit}>
      ...
      <div className="button-group">
        ...
        {currentArticle && <button onClick={handleCancelClick}>Cancel edit</button>}
      </div>
    </form>
  )
}
